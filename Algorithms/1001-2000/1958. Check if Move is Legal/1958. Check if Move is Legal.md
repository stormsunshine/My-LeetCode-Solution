...
![Image text](https://assets.leetcode.com/uploads/2021/07/22/goodlines5.png)

Given two integers `rMove` and `cMove` and a character `color` representing the color you are playing as (white or black), return *`true` if changing cell `(rMove, cMove)` to color `color` is a **legal** move, or `false` if it is not legal*.

**Example 1:**

![Image text](https://assets.leetcode.com/uploads/2021/07/10/grid11.png)
...
![Image text](https://assets.leetcode.com/uploads/2021/07/10/grid2.png)
